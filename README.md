...
|:-------:|:-----------:|:----------:|
| 🌍 **[Wanderlust](https://majorproject-fvii.onrender.com/listings)** | Full-stack Airbnb clone with property listings, location search, maps & reviews | HTML, CSS, JS, Bootstrap, Node.js, Express.js |
| 🤖 **[Decent AI](https://ai-frontend-eta-blond.vercel.app/)** | Production-ready AI web app via Groq API with markdown rendering & syntax highlighting | MERN, TypeScript, JWT |
| 💰 **[Decent Expense](https://finance-front-xi.vercel.app/)** | Finance tracker with real-time dashboards, analytics & interactive charts | MERN, TypeScript, Shadcn, Tailwind |
